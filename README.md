...
- создание задачи по проекту и названию с дополнительными параметрами;
...
- защита от двойной отправки по idempotency key;
- mock-экраны истории, проектов, пользователей и состояния интеграции;
...
- timeout оставляет статус неизвестным и запрещает слепой повтор.
