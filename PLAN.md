...
3. **Portal foundation** — реализовать конфигурацию одного портала и `portal_installations` после завершенного development/test OAuth и portal identity spike.
